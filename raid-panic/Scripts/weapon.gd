...
func _physics_process(_delta: float) -> void:
	if Input.is_action_just_pressed("Hit") and get_parent().get_parent().get_node("PlayerSkeleton") != null and !get_parent().get_parent().get_node("PlayerSkeleton").is_punching():
